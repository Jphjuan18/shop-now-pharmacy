...
const inputFileRef = useRef<HTMLInputElement>(null); // add ref to file input element
...
const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    await setDoc(docRef, {
      ...
      id: docRef.id, // store the unique ID instead of the file name
      isBestSeller: false // store the unique ID instead of the file name
    });
  ...
  return (
    <>
    <div className="max-w-lg mx-auto py-5 px-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <input
            ...
            ref={inputFileRef} // add ref to file input element
            className="border border-gray-200 p-2 rounded"
          />
